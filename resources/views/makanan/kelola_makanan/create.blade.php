        ...
        <form action="{{ route('makanan.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nama_makanan" name="nama_makanan" class="w-full border-gray-300 focus:border-lime-500 focus:ring-lime-500 rounded-md shadow-sm" required>
                </div>

                {{-- Kolom 2 --}}
                <div class="mb-4">
                    <label for="gambar" class="block mb-2 font-medium text-gray-700">Link Gambar</label>
                    <input type="url" id="gambar" name="gambar" class="w-full border-gray-300 focus:border-lime-500 focus:ring-lime-500 rounded-md shadow-sm">
                </div>

                {{-- Kolom 1 --}}
                <div class="mb-4">
                    <label for="kalori" class="block mb-2 font-medium text-gray-700">Kalori</label>
                    <input type="number" id="kalori" name="kalori" step="0.01" class="w-full border-gray-300 focus:border-lime-500 focus:ring-lime-500 rounded-md shadow-sm" required>
                </div>

                {{-- Kolom 2 --}}
                <div class="mb-4">
                    <label for="karbohidrat" class="block mb-2 font-medium text-gray-700">Karbohidrat</label>
                    <input type="number" id="karbohidrat" name="karbohidrat" step="0.01" class="w-full border-gray-300 focus:border-lime-500 focus:ring-lime-500 rounded-md shadow-sm" required>
                </div>

                {{-- Kolom 1 --}}
                <div class="mb-4">
                    <label for="protein" class="block mb-2 font-medium text-gray-700">Protein</label>
                    <input type="number" id="protein" name="protein" step="0.01" class="w-full border-gray-300 focus:border-lime-500 focus:ring-lime-500 rounded-md shadow-sm" required>
                </div>

                {{-- Kolom 2 --}}
                <div class="mb-4">
                    <label for="harga" class="block mb-2 font-medium text-gray-700">Harga</label>
                    <input type="number" id="harga" name="harga" class="w-full border-gray-300 focus:border-lime-500 focus:ring-lime-500 rounded-md shadow-sm" required>
                </div>
